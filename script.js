...
cseandece.addEventListener('click', ()=>{
   ...
   et display =document.getElementById("searchdisplay");
        display.style.display="";
        display.innerHTML="<h1>THIS IS CSE AND ECE BUILDINGS</h1>";
        let anchor =document.getElementById("asearch");
        anchor.style.display="";
        anchor.innerHTML="<H3>CLICK HERE FOR DIRECTIONS</H3>"
...
mech.addEventListener('click', ()=>{
    ...
    let display =document.getElementById("searchdisplay");
        display.style.display="";
        display.innerHTML="<h1>THIS IS NEW-ACADEMIC BUILDING</h1>";
        let anchor =document.getElementById("asearch");
        anchor.style.display="";
        anchor.innerHTML="<H3>CLICK HERE FOR DIRECTIONS</H3>"
...
let display =document.getElementById("searchdisplay");
        display.style.display="";
        display.innerHTML="<h1>THIS IS DELHI CHAAT WALA</h1>";
        let anchor =document.getElementById("asearch");
        anchor.style.display="None";
...
let display =document.getElementById("searchdisplay");
        display.style.display="";
        display.innerHTML="<h1>THIS IS NEW ACADEMICS BUILDING</h1>";
        let anchor =document.getElementById("asearch");
        anchor.style.display="";
        anchor.innerHTML="<H3>CLICK HERE FOR DIRECTIONS</H3>"
        anchor.href="https://www.google.com/maps/place/15%C2%B045'40.9%22N+78%C2%B002'20.9%22E/@15.761361,78.0384853,279m/data=!3m2!1e3!4b1!4m4!3m3!8m2!3d15.761361!4d78.039129?entry=ttu";
...
kalam.addEventListener('click', ()=>{
    ...
    let display =document.getElementById("searchdisplay");
        display.style.display="";
        display.innerHTML="<h1>THIS IS KALAM HOSTEL</h1>";
        let anchor =document.getElementById("asearch");
        anchor.style.display="";
        anchor.innerHTML="<H3>CLICK HERE FOR DIRECTIONS</H3>"
...
let display =document.getElementById("searchdisplay");
        display.style.display="";
        display.innerHTML="<h1>THIS IS OLD ACADEMIC BUILDING</h1>";
        let anchor =document.getElementById("asearch");
        anchor.style.display="";
        anchor.innerHTML="<H3>CLICK HERE FOR DIRECTIONS</H3>"
...
let display =document.getElementById("searchdisplay");
        display.style.display="";
        display.innerHTML="<h1>THIS IS MVHR HOSTEL</h1>";
        let anchor =document.getElementById("asearch");
        anchor.style.display="";
        anchor.innerHTML="<H3>CLICK HERE FOR DIRECTIONS</H3>"
...
let display =document.getElementById("searchdisplay");
        display.style.display="";
        display.innerHTML="<h1>THIS IS KALPANA CHAWLA GIRLS HOSTEL</h1>";
        let anchor =document.getElementById("asearch");
        anchor.style.display="";
        anchor.innerHTML="<H3>CLICK HERE FOR DIRECTIONS</H3>"
